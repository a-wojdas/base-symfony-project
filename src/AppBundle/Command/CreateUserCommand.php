...
You can alternatively specify the email and password as the second and third arguments:
  ...
  <info>php app/console user:create matthieu matthieu@example.com mypassword</info>
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ( $superadmin === true ) {
            $userManager = $this->getContainer()->get('adminuser_manager');
        } else {
            $userManager = $this->getContainer()->get('user_manager');
        }
        
        $userManager->create($username, $password, $email, !$inactive);

        $output->writeln(sprintf('Created ' . ( $superadmin === true ? 'super' : '') . 'user <comment>%s</comment>', $username));
    }
